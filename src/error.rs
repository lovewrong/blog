...
pub enum Error {
    ...
    #[error("an error occurred with the axum")]
    ...
    /// Returns `500 Internal Server Error` on a 'tera::Error'
    #[error("an error occurred with the templates")]
...
impl IntoResponse for Error {
    fn into_response(self) -> Response {
        match self {
            ...
            Self::Templates(ref e) => {
                tracing::error!("Templates error: {:?}", e);
            }
